...
public class MessageBuilder {
    ...
    public static <T extends ResultDataType> Message buildMessage(String from, String to, T data, String msgType, CallbackId callbackId) {
        return buildMessage(from, to, null, data, msgType, callbackId);
    }
